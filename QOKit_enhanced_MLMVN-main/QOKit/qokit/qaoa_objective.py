...
from qokit.energy_qaoa_objective import compute_objective_from_probabilities
...
def _get_qiskit_objective(
    ...
    if mixer == "x":
        ...
        def g(gamma, beta):
            ...
            probs = np.abs(sv) ** 2
            return compute_objective_from_probabilities(probs, objective, precomputed_objectives, bitstring_loc, optimization_type)
