...
from . import csim
from .energy_qaoa_simulator import get_expectation, get_overlap
...
class QAOAFastSimulatorCBase(QAOAFastSimulatorBase):
    ...
    def get_expectation(self, result: ComplexArray, costs: np.ndarray | None = None, optimization_type="min", **kwargs) -> float:
        ...
        return get_expectation(probabilities, costs, optimization_type, **kwargs)
    ...
    def get_overlap(
        ...
        return get_overlap(probs, costs, indices, optimization_type, **kwargs)
